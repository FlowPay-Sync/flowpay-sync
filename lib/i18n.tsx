...
const translations = {
  es: {
    ...
    demo_examples_desc: "Haz clic en un ejemplo para simularlo",
  ...
  en: {
    ...
    demo_examples_desc: "Click an example to simulate it",
